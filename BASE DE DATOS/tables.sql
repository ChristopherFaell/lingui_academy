...
CREATE TABLE classroom_type (
	...
	CONSTRAINT idx_classroom_type_pk PRIMARY KEY (id)
);
...
CREATE TABLE classroom_information (
	...
	classroom_type_id BIGINT UNSIGNED NOT NULL,
	start_date_time DATETIME NOT NULL,
	end_date_time DATETIME NOT NULL,
	duration_hour BIGINT UNSIGNED NOT NULL,
	CONSTRAINT idx_classroom_information_pk PRIMARY KEY (id),
	CONSTRAINT idx_classroom_information_classroom_id_FK FOREIGN KEY (classroom_id) REFERENCES lingui_academy.classroom(id),
	CONSTRAINT idx_classroom_information_modality_id_FK FOREIGN KEY (modality_id) REFERENCES lingui_academy.modality(id),
	CONSTRAINT idx_classroom_information_level_id_FK FOREIGN KEY (level_id) REFERENCES lingui_academy.`level`(id),
	CONSTRAINT idx_classroom_information_unit_id_FK FOREIGN KEY (unit_id) REFERENCES lingui_academy.unit(id),
	CONSTRAINT idx_classroom_information_component_id_FK FOREIGN KEY (component_id) REFERENCES lingui_academy.component(id),
	CONSTRAINT idx_classroom_information_classroom_type_id_FK FOREIGN KEY (classroom_type_id) REFERENCES lingui_academy.classroom_type(id),
	CONSTRAINT idx_classroom_information_teacher_user_language_id_FK FOREIGN KEY (teacher_user_language_id) REFERENCES lingui_academy.teacher_user_language(id)
);

CREATE TABLE student_classroom_information (
	id BIGINT UNSIGNED auto_increment NOT NULL,
	student_id BIGINT UNSIGNED NOT NULL,
	classroom_information_id BIGINT UNSIGNED NOT NULL,
	CONSTRAINT idx_student_classroom_information_pk PRIMARY KEY (id),
	CONSTRAINT idx_student_classroom_information_student_id_FK FOREIGN KEY (student_id) REFERENCES lingui_academy.student(id),
	CONSTRAINT idx_student_classroom_information_classroom_information_id_FK FOREIGN KEY (classroom_information_id) REFERENCES lingui_academy.classroom_information(id)
);
...
CREATE TABLE enrollment_level (
	...
	CONSTRAINT idx_enrollment_level_student_id_FK FOREIGN KEY (student_id) REFERENCES lingui_academy.student(id),
	CONSTRAINT idx_enrollment_level_language_id_FK FOREIGN KEY (language_id) REFERENCES lingui_academy.`language`(id),
